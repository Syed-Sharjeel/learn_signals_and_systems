...
- **Circuit:** Typically an RC series circuit with output taken across the capacitor.  
- **Cutoff Frequency:**  
...
- **Applications:** Audio systems, smoothing signals, removing high-frequency noise.

---

### High-Pass Filter (HPF)
- **Function:** Allows high-frequency signals to pass while attenuating low-frequency signals.  
- **Circuit:** Typically an RC series circuit with output taken across the resistor.  
- **Cutoff Frequency:**  
...
- **Applications:** Coupling AC signals, removing DC offset, signal processing.
